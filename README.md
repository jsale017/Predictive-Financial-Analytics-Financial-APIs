...
What data feed(s) are you considering for project?
...
How often do the data get updated (i.e. new records are available and need to be added to your data warehouse)

●	FinHub and Alpha Vantage data are updated every second, allowing users to access real-time US market data.

Why are you interested in exploring these data feed(s) for your project?
...
What are the business problem(s) you will be exploring once your data are being collected?
